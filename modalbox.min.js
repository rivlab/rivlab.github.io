function showModal(item) {
  ...
  let ic = document.querySelector(".icon_copy");
  ...
  fetch(`./${item}`)
    ...
    .then((e) => {
      console.log("Sdd");
      let lastIndex = Object.entries(e.data).length - 1;
      let currentIndex = 0;
      let tex = "";
    ...
    .catch((e) => {
      (d.style.display = "none"), console.error("Error fetching data:", e);
    });
